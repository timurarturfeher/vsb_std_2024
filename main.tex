...
\definecolor{pozadie}{rgb}{0.95,0.95,0.95}
\definecolor{kluce}{rgb}{0,0,1}
\definecolor{id}{rgb}{0,0.7,0.9}
\definecolor{retazce}{rgb}{1,0,0}
\definecolor{komenty}{rgb}{0,0,0}

\lstset{
    language=Python,
    basicstyle=\ttfamily,
    keywordstyle=\color{kluce}\bfseries,
    identifierstyle=\color{id},
    commentstyle=\color{komenty}\ttfamily,
    stringstyle=\color{retazce},
    backgroundcolor=\color{pozadie},
    breaklines=true,
    frame=single,
...
\addbibresource{CommonFiles/Bibliography/SampleBib.bib}
...
\begin{figure}[H]
  \centering
  \includegraphics{CommonFiles/Figures/Figure003.pdf}
...
\lstinputlisting[language=Python,caption={Lodích končetinách nicméně},label={lst:lodich}]{CommonFiles/SourceCodes/SourceCode1.py}
...
\begin{figure}[H]
  \centering
  \includegraphics{CommonFiles/Figures/Figure010.pdf}
